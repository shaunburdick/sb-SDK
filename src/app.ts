...
import type { APIParams } from './lib/rest';
...
export class TheOneSDK {
     ...
     */
    public constructor(private apiKey?: string, private base?: string) {
        if (!apiKey) {
     ...
     */
    public async movies(params?: APIParams): Promise<LotRMovie[]> {
     ...
     */
    public async movie(id: string): Promise<LotRMovie> {
